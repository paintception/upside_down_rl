...
def get_functional_behaviour_function(state_size, command_size, action_size):
    ...
    linear_layer = Dense(64, activation='linear')(observation_input)
    ...
    layer_1 = Dense(64, activation='linear')(multiplied_layer)
    layer_2 = Dense(64, activation='linear')(layer_1)
    layer_3 = Dense(64, activation='linear')(layer_2)
    layer_4 = Dense(64, activation='linear')(layer_3)
